...
<head>
    ...
    <title>Function Search Buku - Rafi</title>
...
<body class="bg-light">
    <div class="container mt-5 mb-5">
        ...
        <div class="alert alert-dark text-center shadow-sm">
            <strong>M. Rafi Risqiyanto | 60324001</strong> - Praktikum 3 (Pertemuan 4)
        </div>
        ...
        function tampilkan_hasil($hasil, $judul_pencarian) {
            if (count($hasil) > 0) {
                ...
                echo "<div class='table-responsive bg-white shadow-sm p-3 rounded mb-4'>";
                ...
                echo "<div class='alert alert-warning shadow-sm mb-4'>";
