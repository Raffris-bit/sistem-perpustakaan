...
function format_tanggal_indo($tanggal) {
    ...
    $pecahkan = explode('-', $tanggal); // Misal: 2024-01-15 jadi [2024, 01, 15]
    
    // index 2 = tanggal, index 1 = bulan, index 0 = tahun
    return $pecahkan[2] . ' ' . $bulan[ (int)$pecahkan[1] ] . ' ' . $pecahkan[0];
}

// ================= BONUS (+10%) =================

// BONUS 1: Function sort anggota by nama (A-Z)
...
// BONUS 2: Function search anggota by nama (partial match)
